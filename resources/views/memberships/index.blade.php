                    ...
                    <div class="bg-indigo-50 shadow-lg rounded-2xl p-6 hover:shadow-2xl transition duration-300">
                        <div class="flex flex-col h-full">
                            <div class="space-y-2 mb-4">
                                <p class="text-lg font-semibold text-gray-800">{{ $membership->user->firstname }} {{ $membership->user->lastname }}</p>
                                <p class="text-sm text-gray-600"><strong>Membership Level:</strong> <span
                                        class="font-medium text-gray-800">{{ $membership->membershipLevel->name }}</span></p>
                                <p class="text-sm text-gray-600"><strong>Active:</strong> <span
                                        class="font-medium text-gray-800">{{ $membership->active ? 'Yes' : 'No' }}</span></p>
                            </div>
