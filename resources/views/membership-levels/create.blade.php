                ...
                <div class="bg-indigo-50 p-6 rounded-xl shadow-inner space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="4" required
                                  class="w-full p-3 border border-gray-300 rounded-lg text-black focus:ring-2 focus:ring-indigo-500 transition">{{ old('description') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="max_booking_days_ahead" id="max_booking_days_ahead" value="{{ old('max_booking_days_ahead') }}" required
                               class="w-full p-3 border border-gray-300 rounded-lg text-black focus:ring-2 focus:ring-indigo-500 transition" />
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="max_booking_hours" id="max_booking_hours" value="{{ old('max_booking_hours') }}" required
                               class="w-full p-3 border border-gray-300 rounded-lg text-black focus:ring-2 focus:ring-indigo-500 transition" />
                    </div>

                    <!-- Allow Guests -->
                    <div class="flex items-center gap-2">
                        <input type="checkbox" name="allow_guests" id="allow_guests" value="1" {{ old('allow_guests') ? 'checked' : '' }}
                    ...
                    <!-- Access Competitions -->
                    <div class="flex items-center gap-2">
                        <input type="checkbox" name="access_competitions" id="access_competitions" value="1" {{ old('access_competitions') ? 'checked' : '' }}
                               class="rounded border-gray-300 text-indigo-600 focus:ring-2 focus:ring-indigo-500" />
