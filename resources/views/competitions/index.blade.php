            ...
            @foreach($competitions as $competition)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('competitions.edit', $competition->id) }}" class="btn btn-warning btn-sm">Edit</a>
                        <form action="{{ route('competitions.destroy', $competition->id) }}" method="POST" class="d-inline">
                            @csrf @method('DELETE')
                            <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Delete this competition?')">Delete</button>
                        </form>
                    </td>
                </tr>
            @endforeach
