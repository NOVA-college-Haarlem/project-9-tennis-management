    ...
    <div class="container mt-4">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-text"><strong>User:</strong> {{ $registration->user?->firstname ?? 'Unknown' }} {{ $registration->user?->lastname ?? '' }}</p>
                <p class="card-text"><strong>Tournament:</strong> {{ $registration->tournament?->name ?? 'Unknown' }}</p>
                <p class="card-text"><strong>Registration Date:</strong> {{ $registration->registration_date }}</p>
                <p class="card-text"><strong>Status:</strong> <span class="badge bg-primary">{{ ucfirst($registration->status) }}</span></p>
            </div>
        </div>
